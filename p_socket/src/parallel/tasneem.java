...
import static parallel.tasneem.ADDRESS;
 ...
 * @author Linah
 */
public class tasneem extends javax.swing.JFrame{
 static final String ADDRESS = "127.0.0.1";
    static final int PORT = 8001;
    static final String name = "tasneem";
    ...
    static tasneem l= new tasneem();
    
    static double balance=5000;
     static double b_update ;
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "linah", "salma", "monica" }));
    ...
    private void loginbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbtnActionPerformed
        ...
        //Sendd("login",jTextField.getText(),jPasswordField1.getText());
